...
type ProductServiceClient interface {
	GetAllCategories(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*CategoriesMessageResponse, error)
}
...
func (c *productServiceClient) GetAllCategories(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*CategoriesMessageResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CategoriesMessageResponse)
...
type ProductServiceServer interface {
	GetAllCategories(context.Context, *Empty) (*CategoriesMessageResponse, error)
...
func (UnimplementedProductServiceServer) GetAllCategories(context.Context, *Empty) (*CategoriesMessageResponse, error) {
...
func _ProductService_GetAllCategories_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).GetAllCategories(ctx, req.(*Empty))
	}
